...
var arrData = [
	...
	function thirdGreatest (strArray) {
		var thirdLong = strArray.sort(function (a, b) {
		//   var strA = a.toLowerCase(), strB = b.toLowerCase()
		  if (a.length > b.length) //sort string ascending
			return -1
...
console.log(thirdGreatest(arrData));
